...
// I put Skuggi here since they have a perm-silence aura like spectres
{
	MONS_SKUGGI, 'W', YELLOW, "skuggi",
    M_SPEAKS | M_SEE_INVIS | M_WARM_BLOOD | M_FIGHTER,
    mrd(MR_RES_POISON, 2),
    10, MONS_SKUGGI, MONS_SKUGGI, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 440,
    5, 15, MST_NO_SPELLS, CE_CLEAN, S_RANDOM,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
